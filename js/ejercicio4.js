/**
 * Ejercicio4 : Sistema de Clasificación de Edades para Cine
...
const edad = Number(prompt("Ingresa tu edad 7 - 18:")); 

// and = &&
// or = ||

if (edad >= 18 && edad <= 30) {
  console.log("uedes ver Todo tipo de películas (Sin restricción)");
