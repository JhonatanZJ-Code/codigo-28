  ...
  return (
    <section className="m-5">
      ...
      <div>
        ...
        <Title text="Me llamo Jhonatan" size="h6" />
        <Title text="Me llamo Jhonatan" size="h5" />
        <Title text="Me llamo Jhonatan" size="h4" />
        <Title text="Me llamo Jhonatan" size="h3" />
        <Title text="Me llamo Jhonatan" size="h2" />
